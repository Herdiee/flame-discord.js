...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        try {
            ...
            // If the user does not have the correct permissions, return perm error.
            ...
            // if no arguments were provided, return invalid arguments
            ...
            // Check that the member can actually be kicked
            ...
            // Get the reason for the kick and dm the user
            ...
            // Get the logging channel and send embed
